...
// یک آیدی بگیر و دسته هایی که پدرشون این آیدی هست رو به من پس بده
    ...
    fill_batch_list(data, target, image);
    next_page(title);
};
...
const search_item = searched => {
   // یه استرینگ بهت میدم تو آیتم ها و تو دسته ها سرچ کن و نتیجه رو بهم بده
    ...
    fill_list_items(data, "#search_page_2 ul");
};
...
const get_home_root = () => {
    ...
    data = {
        "0":{
            "id" : "3154",
            "name": "مکمل ها",
            "picture": "suppliment.png"
        },
        "1":{
            "id" : "3155",
            "name": "آرایشی",
            "picture": "Sanitary.png"
        },
        "2":{
            "id" : "3156",
            "name": "بهداشتی",
            "picture": "cosmetic.png"
        }
    };
