    ...
    <article class="main_page" id="home">
        <div class="home_page" id="home_page_1">
            <ul class="root_item_list">
                ...
                <?php foreach ($main_batchs as $main_batch): ?>
                    <li onclick="get_batch_list(1, '#home_page_2 ul', '<?= $main_batch[name] ?>', 'images/<?= $main_batch[picture] ?>')" class="home_page_1_buttons" title="<?= $main_batch[name] ?>" target="<?= $main_batch[id] ?>">
                        <p><?= $main_batch[name] ?></p>
                        <img alt="image" src="images/<?= $main_batch[picture] ?>">
                    </li>
                <?php endforeach; ?>
